...
from ..services.chat_fallback import get_fallback_response
...
- If she expresses sadness, loneliness, or depression, be empathetic first, then suggest calling family
...
async def chat(req: ChatRequest) -> ChatResponse:
    ...
    try:
        ...
        reply = get_fallback_response(req.message, req.patient_name)
